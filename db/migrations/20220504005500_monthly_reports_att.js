 ...
 export const up = async knex => {
	try {
		return knex.schema.createTable('reports_att_monthly', table => {
			...
			table.integer('adult_men').notNullable();
			table.integer('adult_women').notNullable();
			table.integer('youth_men').notNullable();
			table.integer('youth_women').notNullable();
			table.integer('teenagers').notNullable();
			table.integer('youngstars').notNullable();
			table.integer('total_adults').notNullable();
			table.integer('total_youths').notNullable();
			table.integer('total_att').notNullable();
			table.integer('avg_men').notNullable();
			table.integer('avg_women').notNullable();
			table.integer('avg_children').notNullable();
			table.integer('avg_adult_men').notNullable();
			table.integer('avg_adult_women').notNullable();
			table.integer('avg_adults').notNullable();
			table.integer('avg_youth_men').notNullable();
			table.integer('avg_youth_women').notNullable();
			table.integer('avg_youths').notNullable();
			table.integer('avg_teenagers').notNullable();
			table.integer('avg_youngstars').notNullable();
			...
			table.integer('workers_at_lgaf').notNullable();
			table.integer('souls_at_lgaf').notNullable();
